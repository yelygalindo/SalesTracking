...
using SalesTracking.Infrastructure.Persistence.Sql.Companies;
...
using SalesTracking.Infrastructure.Persistence.Sql.ProjectMaterials;
...
namespace SalesTracking.Host.Extensions
{
    public static class ServicesRegistrationExtensions
    {
        public static IServiceCollection AddServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IProjectMaterialsService, ProjectMaterialsService>();
            ...
            services.AddScoped<IProjectMaterialsRepository, ProjectMaterialsRepository>();
